import numpy as np
from AI.dezero import cuda
from AI.dezero.core import Function, as_variable
from AI.dezero.utils import pair, get_conv_outsize, get_deconv_outsize
from AI.dezero.functions import linear, broadcast_to
